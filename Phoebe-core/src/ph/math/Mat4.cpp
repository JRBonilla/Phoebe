...
namespace ph { namespace math {
	...
	Mat4::Mat4(const Mat3& mat3) {
		column[0] = Vec4(mat3.column[0].x, mat3.column[0].y, mat3.column[0].z, 0.0f);
		column[1] = Vec4(mat3.column[1].x, mat3.column[1].y, mat3.column[1].z, 0.0f);
		column[2] = Vec4(mat3.column[2].x, mat3.column[2].y, mat3.column[2].z, 0.0f);
	...
	Mat4 Mat4::Rotate(const Quat& quaternion) {
		...
		result.column[0] = Vec4(((1.0f - qyqy2) - qzqz2), (qxqy2 + qzqw2), (qxqz2 - qyqw2), 0.0f);
		result.column[1] = Vec4((qxqy2 - qzqw2), ((1.0f - qxqx2) - qzqz2), (qyqz2 + qxqw2), 0.0f);
		result.column[2] = Vec4((qxqz2 + qyqw2), (qyqz2 - qxqw2), ((1.0f - qxqx2) - qyqy2), 0.0f);
	...
	std::ostream& operator<<(std::ostream& stream, const Mat4& matrix) {
		stream << "mat4: (" << matrix.column[0].x << ", " << matrix.column[1].x << ", " << matrix.column[2].x << ", " << matrix.column[3].x << "), ";
		stream << "(" << matrix.column[0].y << ", " << matrix.column[1].y << ", " << matrix.column[2].y << ", " << matrix.column[3].y << "), ";
		stream << "(" << matrix.column[0].z << ", " << matrix.column[1].z << ", " << matrix.column[2].z << ", " << matrix.column[3].z << "), ";
		stream << "(" << matrix.column[0].w << ", " << matrix.column[1].w << ", " << matrix.column[2].w << ", " << matrix.column[3].w << ")";
		return stream;
	}
